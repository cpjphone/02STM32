...
#define NRF24L01_CE		GPIO_Pin_4  
#define NRF24L01_CSN		GPIO_Pin_4	
#define NRF24L01_IRQ		GPIO_Pin_5
#define    NRF24L01_CE_Pin(x)   x? GPIO_SetBits(GPIOA,NRF24L01_CE):GPIO_ResetBits(GPIOA,NRF24L01_CE)
#define    NRF24L01_CSN_Pin(x)   x ? GPIO_SetBits(GPIOC,NRF24L01_CSN):GPIO_ResetBits(GPIOC,NRF24L01_CSN)
#define    NRF24L01_IRQ_Pin(x)    x ? GPIO_SetBits(GPIOC,NRF24L01_IRQ):GPIO_ResetBits(GPIOC,NRF24L01_IRQ)
//24L01发送接收数据宽度定义
...
u8 NRF24L01_TxPacket(u8 *txbuf)
{
	...
	while(GPIO_ReadInputDataBit(GPIOC,NRF24L01_IRQ)!=0);//等待发送完成
